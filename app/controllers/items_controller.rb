class ItemsController < ApplicationController
  ...
  def index
    ...
    @items = @q.result(:distinct => true).includes(:seller, :category, :comment).page(params[:page]).per(10)
  end
  ...
  def current_user_must_be_item_seller
    ...
    def item_params
      params.require(:item).permit(:item_title, :item_picture, :item_price, :category_id, :item_description, :seller_id, :comment_id)
    end
end
